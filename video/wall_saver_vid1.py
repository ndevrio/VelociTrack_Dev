...
cam_plot3 = win.addPlot(row=2, col=0, colspan=1, pen=(156, 39, 176))
cam_plot3.setTitle("Camera acceleration", size="20pt")
cam_plot3.setYRange(-20, 20, padding=0)
camPlotter3 = cam_plot3.plot(pen=pg.mkPen(255, 100, 100, width=w))

imu_plot1 = win.addPlot(row=0, col=1, colspan=1, pen=(156, 39, 176))
imu_plot1.setTitle("IMU depth", size="20pt")
imu_plot1.setYRange(-10, 1000, padding=0)
imuPlotter1 = imu_plot1.plot(pen=pg.mkPen(255, 255, 255, width=w))
imu_plot1.enableAutoRange()

imu_plot2 = win.addPlot(row=1, col=1, colspan=1, pen=(156, 39, 176))
imu_plot2.setTitle("IMU velocity", size="20pt")
imu_plot2.setYRange(-10, 10, padding=0)
imuPlotter2 = imu_plot2.plot(pen=pg.mkPen(100, 255, 100, width=w))
imu_plot2.enableAutoRange()

imu_plot3 = win.addPlot(row=2, col=1, colspan=1, pen=(156, 39, 176))
imu_plot3.setTitle("IMU acceleration", size="20pt")
imu_plot3.setYRange(-15, 15, padding=0)
imuPlotter3 = imu_plot3.plot(pen=pg.mkPen(255, 100, 100, width=w))
...
def process_data():
    ...
    imu_data_acc[0] = raw_acc_buffer[3] + 0.92
...
def update():
    ...
    camPlotter3.setData(cam_data_acc)

    imuPlotter1.setData(imu_data_dep)
    imuPlotter2.setData(imu_data_vel)
    imuPlotter3.setData(imu_data_acc)
