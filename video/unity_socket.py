...
a1.setYRange(-10, 10, padding=0.1)
a2.setYRange(-10, 10, padding=0.1)
a3.setYRange(-10, 10, padding=0.1)
acc_curve1 = a1.plot(raw_acc_buffer[:, 0], pen=pg.mkPen((0, 255, 0), width=1))
acc_curve2 = a2.plot(raw_acc_buffer[:, 1], pen=pg.mkPen((0, 255, 0), width=1))
acc_curve3 = a3.plot(raw_acc_buffer[:, 2], pen=pg.mkPen((0, 255, 0), width=1))
...
last_time = 0
def process_data():
    global last_time, raw_acc_buffer, server_socket
