...
from mmapdataset import RealSenseDataset, AblationDataset
...
def main():
    ...
    train_dataset = AblationDataset(sys.argv[1], sys.argv[2], sys.argv[3], 0, int(sys.argv[4]))
    test_dataset = AblationDataset(sys.argv[1], sys.argv[2], sys.argv[3], 1, int(sys.argv[4]))

    model = Depth1DCNN(int(sys.argv[4]))
    ...
    with open('output_train_ablation.txt', 'a') as f:
        ...
        checkpoint_callback = ModelCheckpoint(
            ...
            filename=log_time + "_ds=" + sys.argv[4] + "_" + sys.argv[2] + "_" + sys.argv[3] + '_{epoch:02d}-{val_loss:.2f}',  # Checkpoint file name format
